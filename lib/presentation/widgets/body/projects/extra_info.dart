...
class ExtraInfo extends StatefulWidget {
  const ExtraInfo({super.key, required this.useLightMode});
  final bool useLightMode;

  @override
  State<ExtraInfo> createState() => _ExperienceInfoState();
}

class _ExperienceInfoState extends State<ExtraInfo> {
