...
class CompSciSkillsGrid extends StatelessWidget {
  const CompSciSkillsGrid(
      ...
      itemBuilder: (context, index) {
        return SkillsItem(
          service: skillsList == 0
              ? AppConstants.compSciSkillsRow0[index]
              : AppConstants.compSciSkillsRow1[index],
          useLightMode: useLightMode,
        );
      },
      itemCount: AppConstants.compSciSkillsRow0.length,
    );
  }
